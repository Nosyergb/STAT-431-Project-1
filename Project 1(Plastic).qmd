...
Updated_Plastics |>
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
Based on this secondary graph, we can see that countries with English reported as their primary language easily produced the most plastic waste from 2019-2020. French-speaking countries follow in plastic waste production, though there is a noticeable drop-off in the maximum values after these groups.